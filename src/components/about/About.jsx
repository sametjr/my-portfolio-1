    ...
    <div id="about" className="container section">
      ...
      <div className="about_inner_container">
          <p className="left-side">
            Hello dear visitor! I am a web developer and I am passionate about developing games and web applications. I am a self-taught developer and I am always looking for new challenges. I am third year student at Ankara University studying computer engineering. I am also trainee at Google Game and Application Academy.
            <br />
            <br />
